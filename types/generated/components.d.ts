...
export interface ElementsPricing extends Schema.Component {
  collectionName: 'components_elements_pricings';
  info: {
    displayName: 'Pricing';
  };
  attributes: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      ...
      'elements.pricing': ElementsPricing;
